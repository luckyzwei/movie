...
<html style="height:100%">
    <head>
        ...
        <title>wxtest</title>
        <link ref="stylesheet" href="/static/outlib/dist/lib/weui.css">
        <link ref="stylesheet" href="/static/outlib/dist/css/jquery-weui.css">
        <link ref="stylesheet" href="/static/css/wx_style.css">
    </head>
    <body style="height:100%">
        <div class="weui_tab">
            <div class="weui_tab_bd">
                ...
                <div class="weui-row">
                    <span class="title">关键词"{{keyword}}" 共找到{{count}}个结果</span>
                </div>
